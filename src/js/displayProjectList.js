...
class UpdateProjectList {
    ...
    template(){
        const resultArray = [];
        arraySort.getProjectList().forEach(project=>{
            resultArray.push(`<div class="project"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <title>pound</title>
                        <path
    ...
    update(){
        DOMselector.projectContainer.innerHTML=this.template();
    }
}

export default new UpdateProjectList();